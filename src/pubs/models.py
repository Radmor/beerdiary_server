...
class Pub(models. Model):
    ...
    street = models.CharField(_('street'), max_length=256, blank=True, null=True)
    ...
    design_description = models.TextField(_('design description'), blank=True, null=True)
    atmosphere = SliderField(_('atmosphere'), blank=True, null=True)
    atmosphere_description = models.TextField(_('atmosphere description'), blank=True, null=True)
